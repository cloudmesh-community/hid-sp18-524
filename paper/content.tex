...
\title{HPCC Systems: Core Mechanisms and Advantages of the HPCC Systems}
...
\keywords{High-performance computing, Clusters, Big data, Open Source, Parallel Computing}
